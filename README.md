...
1. If running on AWS a r5.xlarge is recommended for Space Invaders.  This is a CPU machine, modifications are required to the code to utilise a CPU.  The code takes approximately two days to run and an average score of around 700 is obtained.  Note use the barebone Ubuntu AMI and follow the instructions below. 
